...
import BaseRawShaderMaterial from 'module/material/BaseRawShaderMaterial';
import loaderUtils from 'module/utils/LoaderUtils';
import TextureUtils from 'module/utils/TextureUtils';
...
class PBRMaterial extends BaseRawShaderMaterial {
    ...
    constructor(obj) {
         ...
         * 更新环境转换
         */
        this.updateEnvironmentTransform = function () {
            // 四元
     ...
     * @param envRotation
     */
    refreshUniforms(camera, envRotation) {
        // 更新环境旋转
    ...
    static create(material) {
        ...
        // '#ffffff' 白色
        pbrMaterial.color = (new Color).setHex(undefined !== material.color ? material.color : 0xffffff)
        pbrMaterial.side = optionalParameter(material.side, FrontSide)
        ...
        pbrMaterial.uEnvironmentTransform = new Matrix4
